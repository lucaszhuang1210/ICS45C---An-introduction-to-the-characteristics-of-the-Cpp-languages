...
// These are the includes that are necessary for the header.
// You might need more in the actual implementation.
// Note that <iosfwd> is a special"stripped down"version
// of <iostream> that's usually good enough for a header file
// but not enough to actually work with iostreams.
#include <iosfwd>
#include <map>
#include <set>
#include <string>
